...
public:
    ...
    float getTemperatureF(uint8_t index);
    float getTemperatureC(String address);
    float getTemperatureF(String index);
    // get string of address by given index on the bus
